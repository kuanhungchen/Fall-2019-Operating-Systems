...
__data __at (0x39) char nextProduce1;
__data __at (0x3A) char nextProduce2;
...
void Producer1(void) {
        ...
        */
        ...
        while (1) {
                ...
                SemaphoreWait(mutex);
                // __critical {
                sharedBuffer[tail] = nextProduce1;
                tail += 1;
                if (tail == 3) tail = 0;
                if (nextProduce1 == 'Z') nextProduce1 = 'A';
                else nextProduce1 += 1;
                // }
...
void Producer2(void) {
        ...
        */
        ...
        while (1) {
                ...
                SemaphoreWait(mutex);
                // __critical {
                sharedBuffer[tail] = nextProduce2;
                tail += 1;
                if (tail == 3) tail = 0;
                if (nextProduce2 == '9') nextProduce2 = '0';
                else nextProduce2 += 1;
                // }
                SemaphoreSignal(mutex);
                SemaphoreSignal(full);
